...
namespace StreamShift.Web.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        private Domain.Entities.AppUser CreateUser()
        {
            ...
            {
                throw new InvalidOperationException($"Can't create an instance of '{nameof(Domain.Entities.AppUser)}'. " +
                    $"Ensure that '{nameof(Domain.Entities.AppUser)}' is not an abstract class and has a parameterless constructor, or alternatively " +
